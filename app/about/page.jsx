      ...
      <div className="max-w-4xl mx-auto px-6 py-12">
        ...
        <div className="bg-white rounded-xl shadow-lg p-8 mb-8">
          ...
          <p className="text-lg text-gray-700 leading-relaxed mb-6">
            ...
            Whether you&rsquo;re a casual reader or a bibliophile with hundreds
            of books, Bookie helps you keep track of your literary adventures
        ...
        <div className="grid md:grid-cols-2 gap-6 mb-8">
          ...
          <div className="bg-white rounded-lg shadow-md p-6">
            ...
            <p className="text-gray-600">
              Create your personal library of favorite books that you can easily
              access and share with friends and family.
            </p>
          </div>
          ...
          <div className="bg-white rounded-lg shadow-md p-6">
            ...
            <p className="text-gray-600">
              Keep track of what you&rsquo;ve read, what you&rsquo;re currently
              reading, and what&rsquo;s on your to-be-read list.
            </p>
          </div>
        </div>
        ...
        <div className="bg-gradient-to-r from-orange-100 to-amber-100 rounded-xl p-8 text-center">
          ...
          <cite className="text-gray-600 text-lg">— Marcus Tullius Cicero</cite>
        </div>
      </div>
    </div>
  );
